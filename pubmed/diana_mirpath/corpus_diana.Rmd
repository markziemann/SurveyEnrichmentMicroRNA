...
Pubmed data were downloaded from the "cited by" pages for four DIANA-miRpath papers
(Downloaded 2023-08-21) for papers published after 2017-01-01.
...
ml <- list.files(".",pattern=".tsv$")

pm <- lapply(ml,read.table)
