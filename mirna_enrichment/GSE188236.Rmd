...
plot(euler(v2),quantities = TRUE, main="Do miR targets undergo differential expression?")
...
plot(euler(v3),quantities = TRUE,main="Do miR target pathways undergo differential expression?")
